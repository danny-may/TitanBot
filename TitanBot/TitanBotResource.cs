...
namespace TitanBot
{
    ...
    {
        public const string PING_HELP_DESCRIPTION = nameof(PING_HELP_DESCRIPTION);
        public const string PING_HELP_USAGE = nameof(PING_HELP_USAGE);
        public const string EDITCOMMAND_HELP_DESCRIPTION = nameof(EDITCOMMAND_HELP_DESCRIPTION);
        public const string EDITCOMMAND_HELP_NOTES = nameof(EDITCOMMAND_HELP_NOTES);
        public const string EDITCOMMAND_HELP_USAGE_SETROLE = nameof(EDITCOMMAND_HELP_USAGE_SETROLE);
        public const string EDITCOMMAND_HELP_USAGE_SETPERM = nameof(EDITCOMMAND_HELP_USAGE_SETPERM);
        public const string EDITCOMMAND_HELP_USAGE_RESET = nameof(EDITCOMMAND_HELP_USAGE_RESET);
        public const string EDITCOMMAND_HELP_USAGE_BLACKLIST = nameof(EDITCOMMAND_HELP_USAGE_BLACKLIST);
        public const string SETTINGS_HELP_DESCRIPTION = nameof(SETTINGS_HELP_DESCRIPTION);
        public const string SETTINGS_HELP_USAGE_DEFAULT = nameof(SETTINGS_HELP_USAGE_DEFAULT);
        public const string SETTINGS_HELP_USAGE_TOGGLE = nameof(SETTINGS_HELP_USAGE_TOGGLE);
        public const string SETTINGS_HELP_USAGE_SET = nameof(SETTINGS_HELP_USAGE_SET);
        public const string SETTINGSRESET_HELP_DESCRIPTION = nameof(SETTINGSRESET_HELP_DESCRIPTION);
        public const string SETTINGSRESET_HELP_USAGE_THISGUILD = nameof(SETTINGSRESET_HELP_USAGE_THISGUILD);
        public const string SETTINGSRESET_HELP_USAGE_GIVENGUILD = nameof(SETTINGSRESET_HELP_USAGE_GIVENGUILD);
        public const string ABOUT_HELP_DESCRIPTION = nameof(ABOUT_HELP_DESCRIPTION);
        public const string ABOUT_HELP_USAGE = nameof(ABOUT_HELP_USAGE);
        public const string DONATE_HELP_DESCRIPTION = nameof(DONATE_HELP_DESCRIPTION);
        public const string DONATE_HELP_USAGE = nameof(DONATE_HELP_USAGE);
        public const string HELP_HELP_DESCRIPTION = nameof(HELP_HELP_DESCRIPTION);
        public const string HELP_HELP_USAGE = nameof(HELP_HELP_USAGE);
        public const string HELP_HELP_USAGE_TUTORIAL = nameof(HELP_HELP_USAGE_TUTORIAL);
        public const string INFO_HELP_DESCRIPTION = nameof(INFO_HELP_DESCRIPTION);
        public const string INFO_HELP_USAGE_LANGUAGE = nameof(INFO_HELP_USAGE_LANGUAGE);
        public const string INFO_HELP_USAGE_TECHNICAL = nameof(INFO_HELP_USAGE_TECHNICAL);
        public const string INVITE_HELP_DESCRIPTION = nameof(INVITE_HELP_DESCRIPTION);
        public const string INVITE_HELP_USAGE = nameof(INVITE_HELP_USAGE);
        public const string PREFIX_HELP_DESCRIPTION = nameof(PREFIX_HELP_DESCRIPTION);
        public const string PREFIX_HELP_USAGE_SHOW = nameof(PREFIX_HELP_USAGE_SHOW);
        public const string PREFIX_HELP_USAGE_SET = nameof(PREFIX_HELP_USAGE_SET);
        public const string DBPURGE_HELP_DESCRIPTION = nameof(DBPURGE_HELP_DESCRIPTION);
        public const string DBPURGE_HELP_USAGE = nameof(DBPURGE_HELP_USAGE);
        public const string EXEC_HELP_DESCRIPTION = nameof(EXEC_HELP_DESCRIPTION);
        public const string EXEC_HELP_NOTES = nameof(EXEC_HELP_NOTES);
        public const string EXEC_HELP_USAGE = nameof(EXEC_HELP_USAGE);
        public const string GLOBALSETTINGS_HELP_DESCRIPTION = nameof(GLOBALSETTINGS_HELP_DESCRIPTION);
        public const string GLOBALSETTINGS_HELP_USAGE_DEFAULT = nameof(GLOBALSETTINGS_HELP_USAGE_DEFAULT);
        public const string GLOBALSETTINGS_HELP_USAGE_TOGGLE = nameof(GLOBALSETTINGS_HELP_USAGE_TOGGLE);
        public const string GLOBALSETTINGS_HELP_USAGE_SET = nameof(GLOBALSETTINGS_HELP_USAGE_SET);
        public const string SHUTDOWN_HELP_DESCRIPTION = nameof(SHUTDOWN_HELP_DESCRIPTION);
        public const string SHUTDOWN_HELP_USAGE = nameof(SHUTDOWN_HELP_USAGE);
        public const string SUDOCOMMAND_HELP_DESCRIPTION = nameof(SUDOCOMMAND_HELP_DESCRIPTION);
        public const string SUDOCOMMAND_HELP_USAGE = nameof(SUDOCOMMAND_HELP_USAGE);
        public const string PREFERENCES_HELP_DESCRIPTION = nameof(PREFERENCES_HELP_DESCRIPTION);
        public const string PREFERENCES_HELP_USAGE_DEFAULT = nameof(PREFERENCES_HELP_USAGE_DEFAULT);
        public const string PREFERENCES_HELP_USAGE_TOGGLE = nameof(PREFERENCES_HELP_USAGE_TOGGLE);
        public const string PREFERENCES_HELP_USAGE_SET = nameof(PREFERENCES_HELP_USAGE_SET);
        public const string RELOAD_HELP_DESCRIPTION = nameof(RELOAD_HELP_DESCRIPTION);
        public const string RELOAD_HELP_USAGE = nameof(RELOAD_HELP_USAGE);
        public const string RELOAD_HELP_USAGE_LIST = nameof(RELOAD_HELP_USAGE_LIST);
        public const string EXCEPTION_HELP_DESCRIPTION = nameof(EXCEPTION_HELP_DESCRIPTION);
        public const string EXCEPTION_HELP_USAGE = nameof(EXCEPTION_HELP_USAGE);
        public const string EXCEPTION_HELP_FLAG_F = nameof(EXCEPTION_HELP_FLAG_F);

        public const string SETTINGS_GUILD_GENERAL_DESCRIPTION = nameof(SETTINGS_GUILD_GENERAL_DESCRIPTION);
        public const string SETTINGS_GUILD_GENERAL_NOTES = nameof(SETTINGS_GUILD_GENERAL_NOTES);
        public const string SETTINGS_GLOBAL_GENERAL_DESCRIPTION = nameof(SETTINGS_GLOBAL_GENERAL_DESCRIPTION);
        public const string SETTINGS_USER_GENERAL_DESCRIPTION = nameof(SETTINGS_USER_GENERAL_DESCRIPTION);
        public const string LOCALE_UNKNOWN = nameof(LOCALE_UNKNOWN);
        public const string FORMATTINGTYPE_UNKNOWN = nameof(FORMATTINGTYPE_UNKNOWN);

        public const string COMMANDEXECUTOR_COMMAND_UNKNOWN = nameof(COMMANDEXECUTOR_COMMAND_UNKNOWN);
        public const string COMMANDEXECUTOR_DISALLOWED_CHANNEL = nameof(COMMANDEXECUTOR_DISALLOWED_CHANNEL);
        public const string COMMANDEXECUTOR_SUBCALL_UNKNOWN = nameof(COMMANDEXECUTOR_SUBCALL_UNKNOWN);
        public const string COMMANDEXECUTOR_SUBCALL_UNSPECIFIED = nameof(COMMANDEXECUTOR_SUBCALL_UNSPECIFIED);
        public const string COMMANDEXECUTOR_ARGUMENTS_TOOMANY = nameof(COMMANDEXECUTOR_ARGUMENTS_TOOMANY);
        public const string COMMANDEXECUTOR_ARGUMENTS_TOOFEW = nameof(COMMANDEXECUTOR_ARGUMENTS_TOOFEW);
        public const string COMMANDEXECUTOR_EXCEPTION_ALERT = nameof(COMMANDEXECUTOR_EXCEPTION_ALERT);
        public const string PERMISSIONMANAGER_DISALLOWED_NOTHERE = nameof(PERMISSIONMANAGER_DISALLOWED_NOTHERE);
        public const string PERMISSIONMANAGER_DISALLOWED_NOTOWNER = nameof(PERMISSIONMANAGER_DISALLOWED_NOTOWNER);
        public const string PERMISSIONMANAGER_DISALLOWED_NOPERMISSION = nameof(PERMISSIONMANAGER_DISALLOWED_NOPERMISSION);
        public const string COMMAND_DELAY_DEFAULT = nameof(COMMAND_DELAY_DEFAULT);
        public const string TYPEREADER_UNABLETOREAD = nameof(TYPEREADER_UNABLETOREAD);
        public const string TYPEREADER_NOTYPEREADER = nameof(TYPEREADER_NOTYPEREADER);
        public const string TYPEREADER_ENTITY_NOTFOUND = nameof(TYPEREADER_ENTITY_NOTFOUND);
        public const string UNABLE_SEND = nameof(UNABLE_SEND);
        public const string MESSAGE_TOO_LONG = nameof(MESSAGE_TOO_LONG);
        public const string MESSAGE_CONTAINED_ATTACHMENT = nameof(MESSAGE_CONTAINED_ATTACHMENT);

        public const string PING_INITIAL = nameof(PING_INITIAL);
        public const string PING_VERIFY = nameof(PING_VERIFY);
        public const string INFO_LANGUAGE_EMBED_DESCRIPTION = nameof(INFO_LANGUAGE_EMBED_DESCRIPTION);
        public const string EDITCOMMAND_FINDCALLS_NORESULTS = nameof(EDITCOMMAND_FINDCALLS_NORESULTS);
        public const string EDITCOMMAND_SUCCESS = nameof(EDITCOMMAND_SUCCESS);
        public const string SETTINGS_FOOTERTEXT = nameof(SETTINGS_FOOTERTEXT);
        public const string SETTINGS_TITLE_NOGROUP = nameof(SETTINGS_TITLE_NOGROUP);
        public const string SETTINGS_DESCRIPTION_NOSETTINGS = nameof(SETTINGS_DESCRIPTION_NOSETTINGS);
        public const string SETTINGS_INVALIDGROUP = nameof(SETTINGS_INVALIDGROUP);
        public const string SETTINGS_TITLE_GROUP = nameof(SETTINGS_TITLE_GROUP);
        public const string SETTINGS_NOTSET = nameof(SETTINGS_NOTSET);
        public const string SETTINGS_KEY_NOTFOUND = nameof(SETTINGS_KEY_NOTFOUND);
        public const string SETTINGS_UNABLE_TOGGLE = nameof(SETTINGS_UNABLE_TOGGLE);
        public const string SETTINGS_VALUE_INVALID = nameof(SETTINGS_VALUE_INVALID);
        public const string SETTINGS_VALUE_CHANGED_TITLE = nameof(SETTINGS_VALUE_CHANGED_TITLE);
        public const string SETTING_VALUE_OLD = nameof(SETTING_VALUE_OLD);
        public const string SETTING_VALUE_NEW = nameof(SETTING_VALUE_NEW);
        public const string SETTINGRESET_GUILD_NOTEXIST = nameof(SETTINGRESET_GUILD_NOTEXIST);
        public const string SETTINGRESET_SUCCESS = nameof(SETTINGRESET_SUCCESS);
        public const string ABOUT_MESSAGE = nameof(ABOUT_MESSAGE);
        public const string DONATE_MESSAGE_ADDITIONAL = nameof(DONATE_MESSAGE_ADDITIONAL);
        public const string HELP_LIST_TITLE = nameof(HELP_LIST_TITLE);
        public const string HELP_LIST_DESCRIPTION = nameof(HELP_LIST_DESCRIPTION);
        public const string HELP_LIST_COMMAND = nameof(HELP_LIST_COMMAND);
        public const string HELP_SINGLE_UNRECOGNISED = nameof(HELP_SINGLE_UNRECOGNISED);
        public const string HELP_SINGLE_NOUSAGE = nameof(HELP_SINGLE_NOUSAGE);
        public const string HELP_SINGLE_NODESCRIPTION = nameof(HELP_SINGLE_NODESCRIPTION);
        public const string HELP_SINGLE_NOGROUP = nameof(HELP_SINGLE_NOGROUP);
        public const string HELP_SINGLE_TITLE = nameof(HELP_SINGLE_TITLE);
        public const string HELP_SINGLE_USAGE_FOOTER = nameof(HELP_SINGLE_USAGE_FOOTER);
        public const string INFO_FIELD_GUILDS = nameof(INFO_FIELD_GUILDS);
        public const string INFO_FIELD_CHANNELS = nameof(INFO_FIELD_CHANNELS);
        public const string INFO_FIELD_USERS = nameof(INFO_FIELD_USERS);
        public const string INFO_FIELD_COMMANDS = nameof(INFO_FIELD_COMMANDS);
        public const string INFO_FIELD_CALLS = nameof(INFO_FIELD_CALLS);
        public const string INFO_FIELD_COMMANDS_USED = nameof(INFO_FIELD_COMMANDS_USED);
        public const string INFO_FIELD_DATABASE_QUERIES = nameof(INFO_FIELD_DATABASE_QUERIES);
        public const string INFO_FIELD_FACTORY_BUILT = nameof(INFO_FIELD_FACTORY_BUILT);
        public const string INFO_FIELD_RAM = nameof(INFO_FIELD_RAM);
        public const string INFO_FIELD_CPU = nameof(INFO_FIELD_CPU);
        public const string INFO_FIELD_TIMERS = nameof(INFO_FIELD_TIMERS);
        public const string INFO_FIELD_UPTIME = nameof(INFO_FIELD_UPTIME);
        public const string INFO_LANGUAGE_COVERAGE = nameof(INFO_LANGUAGE_COVERAGE);
        public const string INFO_TECHNICAL_TITLE = nameof(INFO_TECHNICAL_TITLE);
        public const string INVITE_MESSAGE = nameof(INVITE_MESSAGE);
        public const string PREFIX_SHOW_NOPREFIX = nameof(PREFIX_SHOW_NOPREFIX);
        public const string PREFIX_SHOW_MESSAGE = nameof(PREFIX_SHOW_MESSAGE);
        public const string PREFIX_SET_MESSAGE = nameof(PREFIX_SET_MESSAGE);
        public const string DBPURGE_SUCCESS = nameof(DBPURGE_SUCCESS);
        public const string EXEC_FOOTER_CONSTRUCTFAILED = nameof(EXEC_FOOTER_CONSTRUCTFAILED);
        public const string EXEC_FOOTER_COMPILEFAILED = nameof(EXEC_FOOTER_COMPILEFAILED);
        public const string EXEC_FOOTER_EXECUTEFAILED = nameof(EXEC_FOOTER_EXECUTEFAILED);
        public const string EXEC_FOOTER_SUCCESS = nameof(EXEC_FOOTER_SUCCESS);
        public const string EXEC_INPUT_FORMAT = nameof(EXEC_INPUT_FORMAT);
        public const string EXEC_OUTPUT_NULL = nameof(EXEC_OUTPUT_NULL);
        public const string EXEC_OUTPUT_FORMAT = nameof(EXEC_OUTPUT_FORMAT);
        public const string EXEC_TITLE_EXCEPTION = nameof(EXEC_TITLE_EXCEPTION);
        public const string EXEC_TITLE_SUCCESS = nameof(EXEC_TITLE_SUCCESS);
        public const string SHUTDOWN_INTIME = nameof(SHUTDOWN_INTIME);
        public const string SUDOCOMMAND_SUCCESS = nameof(SUDOCOMMAND_SUCCESS);
        public const string EXCEPTION_NOTFOUND = nameof(EXCEPTION_NOTFOUND);
        public const string EXCEPTION_MESSAGE = nameof(EXCEPTION_MESSAGE);
        public const string EXCEPTION_CHANNEL = nameof(EXCEPTION_CHANNEL);
        public const string EXCEPTION_GUILD = nameof(EXCEPTION_GUILD);
        public const string EXCEPTION_FULLMESSAGE = nameof(EXCEPTION_FULLMESSAGE);
        public const string EXCEPTION_USER = nameof(EXCEPTION_USER);
        public const string RELOAD_AREA_NOTFOUND = nameof(RELOAD_AREA_NOTFOUND);
        public const string RELOAD_SUCCESS = nameof(RELOAD_SUCCESS);
        public const string RELOAD_LIST = nameof(RELOAD_LIST);

        public const string EMBED_FOOTER = nameof(EMBED_FOOTER);
