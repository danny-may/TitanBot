...
namespace TitanBot2.Commands.General
{
    ...
    class AboutCommand : Command
    {
        ...
        async Task ShowAbout()
        {
            ...
            {
                _specialThanks.Add(181829392027090954, "Awesome guy, helped out with the initial testing of titanbot");
                _specialThanks.Add(196387723018240000, $"Kept pestering {Client.GetUser(135556895086870528).Username} for things to be added");
                _specialThanks.Add(257960645725650954, "Did all the images for the equipment");
                _specialThanks.Add(130084593515626496, "Made my avatar and makes other cool things");
            }
