...
namespace TitanBot2.Commands.General
{
    ...
    class AboutCommand : Command
    {
        ...
        {
            var message = $"'Ello there :wave:, Im {BotUser.Username}! Im an open source discord bot dedicated to TT2 written in C# by {Client.GetUser(135556895086870528).Username}.\n" +
            ...
            message = message + $"  {count++}. Everyone from the {Client.GetGuild(255058878268571649)?.Name} clan for giving {Client.GetUser(135556895086870528).Username} the initial idea\n";
